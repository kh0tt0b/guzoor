...
export const sermons: Sermon[] = [
  {
    ...
    descriptionAr:
      'من منتدى الشيخ الترابي للدراسات القرآنية: حلقة سورة يس ضمن سلسلة التفسير التوحيدي، تُقرأ كرؤيةٍ واحدة موحدة.',
  },
  {
    id: 'sermon-remembrance',
    title: 'The Intellect in the Qur’an',
    titleAr: 'العقل في القرآن',
    ...
    descriptionAr:
      'من مجالس الفكر والذكر — دورة في فهم الدين وتدبر آياته، عن مكانة العقل في الوحي.',
  },
  {
    id: 'sermon-eulogy',
    title: 'A Eulogy for the Martyrs',
    titleAr: 'رثاءٌ للشهداء',
    ...
    descriptionAr:
      'شعرٌ في ذكرى شهداء الخطوط — ومنهم أسطورة الدبابين أمين دولب، بأبياتٍ حملت ألحان الأولين.',
  },
  {
    id: 'sermon-patience',
    title: 'Patience: The Seal of the Companions',
    titleAr: 'الصبر: ختم الصحابة',
    ...
    descriptionAr:
      'عن الصبر بوصفه يقينًا أن الشهيد لم يرحل بل انتقل ليحيا عند ربه — السلوى التي تحوّل حزن الفراق إلى برد وسلام.',
  },
]
